                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr class="gradeA">
                                                        ...
                                                        <td><a href="employee?id=<?php echo $employee_id; ?>" class="btn btn-success btn-xs">Details</a>
                                                            <a href="editemployee?id=<?php echo $employee_id; ?>" class="btn btn-primary btn-xs">Edit</a>
                                                            <a href="hideemployee?id=<?php echo $employee_id; ?>" class="btn btn-danger btn-xs" onclick="return confirm_delete<?php echo $employee_id; ?>()">Remove</a>
