...
<head>
    ...
    <title>Bar Tables | Hotel Manager</title>
...
//                            include_once 'includes/thumbs3.php';
             ...
             mysqli_query($con,"INSERT INTO hoteltables VALUES('','$table','".$_SESSION['emp_id']."','bar','1')") or die(mysqli_errno($con));
...
echo '<div class="alert alert-success"><i class="fa fa-check"></i>Table successfully added</div>';
  ...
  <form method="post" class="form-horizontal" action=''  name="form" enctype="multipart/form-data">
                ...
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
<?php
$tables=mysqli_query($con,"SELECT * FROM hoteltables WHERE area='bar' AND status='1'");
