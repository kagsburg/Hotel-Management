...
<head>
    ...
    <title>Get Laundry Report- Hotel Manager</title>
                        ...
                        <div class="col-lg-8">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Generate Laundry Report <small>All fields marked (*) shouldn't be left blank</small></h5>

                                </div>
                                <div class="ibox-content">
                                    <form method="GET" name='form' class="" action="laundryreport">
                                        <div class="row">
