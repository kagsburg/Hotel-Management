...
<head>
    ...
    <title>Get Reservations Report- Hotel Manager</title>
...
<body>
    ...
    if ((isset($_SESSION['lan'])) && ($_SESSION['lan'] == 'fr')) {
        include 'fr/getreservationreport.php';
    } else {
    ?>
        <div id="wrapper">
                        ...
                        <div class="col-lg-8">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Generate Reservations Report <small>All fields marked (*) shouldn't be left blank</small></h5>

                                </div>
                                <div class="ibox-content">
                                    <form method="GET" name='form' class="form" action="reservationsreport">
                                        <div class="row">
