...
<head>
    ...
    <title>Get Expenses Report- Hotel Manager</title>
...
<body>
    ...
    if ((isset($_SESSION['lan'])) && ($_SESSION['lan'] == 'fr')) {
        include 'fr/getexpensesreport.php';
    } else {
    ?>
        <div id="wrapper">
                        ...
                        <div class="col-lg-8">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Generate Expense Report <small>All fields marked (*) shouldn't be left blank</small></h5>
