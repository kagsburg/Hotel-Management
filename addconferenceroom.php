...
<head>
    ...
    <title>Add Conference Room | Hotel Manager</title>
...
<?php
     if((isset($_SESSION['lan']))&&($_SESSION['lan']=='fr')){ 
                                           include 'fr/addconferenceroom.php';                     
                                       }else{
          ?>          
    <div id="wrapper">
                   ...
                   <div class="col-lg-5">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Add Conference Room<small>Ensure to fill all necessary fields</small></h5>
