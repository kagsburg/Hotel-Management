...
<head>
    ...
    <title>Gym and Pool Subscriptions | Hotel Manager</title>
...
<body>
    ...
    if ((isset($_SESSION['lan'])) && ($_SESSION['lan'] == 'fr')) {
        include 'fr/gymsubscriptions.php';
    } else {
    ?>
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        <h2>Gym and Pool Subscriptions</h2>
                        <ol class="breadcrumb">
                            <li> <a href=""><i class="fa fa-home"></i> Home</a> </li>


                            <li class="active">
                                <strong>View Gym and Pool Subscriptions</strong>
                            </li>
                        </ol>
                    </div>
                    <div class="col-lg-2">
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>All Gym and Pool Subscriptions <small>Sort, search</small></h5>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr class="gradeA">
                                                        ...
                                                        <td>
                                                            <a href="editgymsubscription?id=<?php echo $gymsubscription_id; ?>" class="btn btn-xs btn-info">Edit</a>
                                                            <a href="removesubscription?id=<?php echo $gymsubscription_id; ?>" class="btn btn-xs btn-danger" onclick="return cdelete<?php echo $gymsubscription_id; ?>()">Remove</a>
