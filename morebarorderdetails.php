        ...
        <div class="wrapper wrapper-content">
                ...
                <div class="col-lg-5">
                 ...
                 <div class="feed-activity-list">
                    ...
                    <a href="addmoreborder?id=<?php echo $order_id; ?>&&waiter=<?php echo $waiter; ?>&&instructions=<?php echo $instructions;?>" class="btn btn-success"><i class="fa fa-save"></i> Save Order</a>
                                 </div>
