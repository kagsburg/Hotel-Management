...
<head>
    ...
    <title>Get Stock Report- Hotel Manager</title>
                        ...
                        <div class="col-lg-6">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Generate Stock Report <small>All fields marked (*) shouldn't be left blank</small></h5>

                                </div>
                                <div class="ibox-content">
                                    <form method="GET" name='form' class="form" action="stockreport">
                                        <div class="row">
