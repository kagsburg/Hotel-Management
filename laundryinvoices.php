...
<head>
    ...
    <title>Laundry Invoices | Hotel Manager</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        <h2>Hotel Laundry Invoices between <?php echo date('d/m/Y H:i', $start); ?> and <?php echo date('d/m/Y H:i', $end); ?></h2>
                        <ol class="breadcrumb">
                         ...
                         <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>All Laundry Invoices <small>Sort, search</small></h5>
                                </div>
                                <div class="ibox-content">
                                    <?php
                                    $totallaundry = 0;
                                    $laundry = mysqli_query($con, "SELECT * FROM laundry WHERE status IN (0,1) AND timestamp>='$start' AND timestamp<='$end'GROUP BY reserve_id,customername ORDER BY laundry_id DESC");
                                                    ...
                                                    <tr class="gradeA">
                                                        ...
                                                        <td>
                                                           <?php 
                                                            ...
                                                            <a href="addlaundrypayment?id=<?php echo $laundry_id; ?>" class="btn btn-xs btn-info">Edit</a>
