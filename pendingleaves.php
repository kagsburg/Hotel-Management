...
<head>
    ...
    <title>Pending Leaves | Hotel Manager</title>
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="active">
                                <strong>View Pending Leaves</strong>
                            </li>
                        </ol>
                    </div>
                    <div class="col-lg-2">
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>All Pending Leaves <small>Sort, search</small></h5>
                                </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr class="gradeA">
                                                    ...
                                                    <td>
                                                        <a href="editleave?id=<?php echo $leave_id; ?>" class="btn btn-xs btn-info">Edit</a>
                                                        <a href="approveleave?id=<?php echo $leave_id; ?>" class="btn btn-xs btn-primary" onclick="return approve<?php echo $leave_id; ?>()">Approve</a>
