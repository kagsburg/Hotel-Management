...
<head>
    ...
    <title>Hall Guests checked out With Balance | Hotel Manager</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        <h2>Hall Guests checked out With Balance </h2>
                        <ol class="breadcrumb">
                            <li> <a href=""><i class="fa fa-home"></i> Home</a> </li>


                            <li class="active">
                                <strong>Hall Guests checked out With Balance </strong>
                            </li>
                        </ol>
                    </div>
                    <div class="col-lg-2">
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Hall Guests checked out With Balance <small>Sort, search</small></h5>
                                </div>
