...
<head>
    ...
    <title>Edit Measurement | Hotel Manager</title>
...
echo '<div class="alert alert-success"><i class="fa fa-check"></i>Measurement successfully Edited</div>';
  ...
  <form method="post" class="form-horizontal" action=''  name="form" enctype="multipart/form-data">
                                <div class="form-group"><label class="col-sm-3 control-label">Edit Measurement</label>

                                    <div class="col-sm-9"><input type="text" class="form-control" name='measurement' value="<?php echo $measure; ?>" placeholder="Enter item" required='required'></div>
                                </div>
                             
                                                                                                                                  <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                                                           <button class="btn btn-primary" name="submit" type="submit">Edit Measurement</button>
                                    </div>
                                </div>
                            </form>
