...
<head>
   ...
   <title>Restaurant Invoices | Hotel Manager</title>
      ...
      <div id="wrapper">
         ...
         <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
               <div class="col-lg-12">
                  <h2>Restaurant Invoices between <?php echo date('d/m/Y H:i', $start); ?> and <?php echo date('d/m/Y H:i', $end); ?></h2>
                  <ol class="breadcrumb">
                  ...
                  <div class="col-lg-12">
                     <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                           <?php
                           $restorders = mysqli_query($con, "SELECT * FROM orders WHERE  timestamp>='$start' AND timestamp<='$end'  ORDER BY order_id AND guest='0' DESC");
                                    ...
                                    ?>
                                       <tr class="gradeA">
                                          ...
                                          <td>
                                             ...
                                             <?php /* if ($totalbill > $totalpaid){ ?> disabled <?php   }  */?> 
