...
$accuratedatetime = date('d/m/Y H:i');
...
<head>
   ...
   <title>Reservation Invoices | Hotel Manager</title>
      ...
      <div id="wrapper">
         ...
         <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
               <div class="col-lg-10">
                  <h2>Reservation invoices between <?php echo date('d/m/Y H:i', $start); ?> 
                  and <?php echo date('d/m/Y H:i', $end); ?></h2>
                  <ol class="breadcrumb">
            ...
            <div class="wrapper wrapper-content animated fadeInRight">
               <div class="row">
                  <div class="col-lg-12">
                  <div class="d-flex">
                  <a href="reservationinvoicesprint?st=<?php echo $start; ?>&en=<?php echo $end; ?>" 
                  target="_blank" class="btn btn-success mr-3">Print PDF</a>&nbsp;&nbsp;
                  <a href="reservationinvoicesexcel?st=<?php echo $start; ?>&en=<?php echo $end; ?>"
           ...
           ?>
                    ...
                    while ($row =  mysqli_fetch_array($reservations)) {
                        ...
                        if (!empty($currency) && $currency !== "USD") {
                            $getcurrencies = mysqli_query($con, "SELECT * FROM rates WHERE currency='$currency' 
                                          AND status='1'");
                        ...
                        if (mysqli_num_rows($getotherservices) > 0) {
                            while ($row3 = mysqli_fetch_array($getotherservices)) {
                                ...
                                $redux = $row3['reduction'];
                                $reduction = (int)$redux * (int)$rate;
                        ...
                        if ($status != 2) {
                            $getpayments = mysqli_query($con, "SELECT SUM(amount) AS totalpaid FROM payments 
                        ...
                        ?>
                                          ...
                                          <td><?php echo number_format($totalotherservices); ?></td>
                        ...
                        $row6 = mysqli_fetch_array($employee);
                        $fulname = $row6['fullname'];
                        echo $fulname; ?></td>
                                          <td><?php echo date('d/m/Y H:i:s', $timecreated); ?></td>
                                          <td>
                                             <a href="proforma?id=<?php echo $reservation_id; ?>" class="btn btn-xs btn-info">View</a>
                                             <a href="addpayment?id=<?php echo $reservation_id; ?>" class="btn btn-xs btn-info">Edit</a>
