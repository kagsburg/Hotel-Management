...
<head>
    ...
    <title>Add Stock Item | Hotel Manager</title>
                        ...
                        <div class="col-lg-7">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    ...
                                    <h5>Add Stock Item<small> Ensure to fill all necessary fields</small></h5>
                                </div>
                                <div class="ibox-content">
                                    ...
                                    if (isset($_POST['item'], $_POST['measurement'])) {
                                        if ((empty($_POST['measurement'])) || (empty($_POST['item'])) || (empty($_POST['category']))) {
                                            ...
                                            mysqli_query($con, "INSERT INTO stock_items(stock_item,category_id,minstock,measurement,price,status) VALUES('$item','$category','$minstock','$measurement','$price','1')") or die(mysqli_errno($con));
                                    ...
                                    <form method="post" class="form" action='' name="form" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group"><label class="control-label">Minimum Stock</label>
                                            <input type="text" class="form-control" name='minstock' placeholder="Enter minimum">
                                        </div>
                                        <div class="form-group"><label class="control-label">Price</label>
                                            <input type="text" class="form-control" name='price' placeholder="Enter price">
                                        </div>
                                        <div class="form-group">
                                            <button class="btn btn-primary" name="submit" type="submit">Add Item</button>
                                        </div>
                                    </form>
