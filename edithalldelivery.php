...
<head>
    ...
    <title>Edit Hall Delivery Note - Hotel Manager</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        <h2>Edit Hall Reservation Delivery Note</h2>
                        <ol class="breadcrumb">
                        ...
                        <div class="col-lg-10">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Delivery Note <small>All fields marked (*) shouldn't be left blank</small></h5>
                                </div>
                                <div class="ibox-content">
                                    ...
                                    ?>
                                            ...
                                            if (mysqli_num_rows($delivery) === 0) {
                                                mysqli_query($con, "INSERT INTO halldelivery(hallreservation_id,room_id,fullname,phone,people,charge,country,checkin,checkout,description,reason,vat,timestamp,creator,status,discount) VALUES('$id','$room_id','$fullname','$phone','$people','$charge','$country','$checkin','$checkout','$description','','0',UNIX_TIMESTAMP(),'" . $_SESSION['emp_id'] . "','1','')") or die(mysqli_error($con));
                                            } else {
                                                mysqli_query($con, "UPDATE halldelivery SET room_id='$room_id',fullname='$fullname',phone='$phone',people='$people',charge='$charge',country='$country',checkin='$checkin',checkout='$checkout',description='$description' WHERE hallreservation_id='$id'") or die(mysqli_error($con));
                                            }
                                            $allbuffets = sizeof($buffets);
                                            $items = $_POST['items'] ?? [];
                                            $buffetdays = $_POST['buffet_days'] ?? [];
                                            mysqli_query($con, "DELETE FROM halldelivery_buffets WHERE hallbooking_id='$id'") or die(mysqli_error($con));
                                            ...
                                            foreach ($buffets as $key => $value) {
                                                ...
                                                if (!empty($buffet_id)) {
                                                    mysqli_query($con, "INSERT INTO halldelivery_buffets(hallbooking_id,hallbuffet_id,price,otheritems,days,status) VALUES('$id','$buffet_id','$price','$itemslist','$bdays',1)") or die(mysqli_error($con));
                                                }
                                            }
                                            //   mysqli_query($con,"INSERT INTO halldelivery_buffets(hallbooking_id,hallbuffet_id,price,otheritems,status) VALUES('$id','$buffet_id','$price','$itemslist',1)") or die(mysqli_error($con));

                                            mysqli_query($con, "DELETE FROM halldelivery_services WHERE hallreservation_id='$id'") or die(mysqli_error($con));
                                            ...
                                            foreach ($service as $i => $bookingservice) {
                                                ...
                                                mysqli_query($con, "INSERT INTO halldelivery_services(hallreservation_id,service,price,quantity,days,status) VALUES('$id','$service_id','$price','$quantity[$i]','$servicedays[$i]',1)");
                                            }

                                            mysqli_query($con, "DELETE FROM halldelivery_services2 WHERE hallreservation_id='$id'") or die(mysqli_error($con));

                                            foreach ($otherservice as $i => $oservice) {
                                                mysqli_query($con, "INSERT INTO halldelivery_services2(hallreservation_id,service,price,status) VALUES('$id','$oservice','$othercharge[$i]',1)");
                                            }

                                            ?>
                                            <div class="col-sm-2"></div>
                                            <div class="col-sm-10">
                                                <div class="alert alert-success"><i class="fa fa-check"></i>Delivery Note Successfully updated.</div>
                                            </div>
                                    <?php
                                        }
                                    }
                                    ...
                                    $reservations = mysqli_query($con, "SELECT * FROM $reservetable WHERE hallreservation_id='$id'");
                                    ...
                                    <form method="post" name='form' class="form" action="" enctype="multipart/form-data">
                                        ...
                                        <div class='buffetsec'>
                                            ...
                                            <?php
                                            $count = -1;
                                            $getbuffets = mysqli_query($con, "SELECT * FROM $buffetstable WHERE hallbooking_id='$id'") or die(mysqli_error($con));
                                        ...
                                        <div class='subobj3'>
                                            ...
                                            <?php
                                            $getservices = mysqli_query($con, "SELECT * FROM $services2table WHERE hallreservation_id='$id'");
                                            while ($row = mysqli_fetch_array($getservices)) {
                                                $hallservice_id = $row['hallservice_id'];
                                                $service = $row['service'];
                                                $price = $row['price'];
