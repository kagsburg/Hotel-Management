    <div id="wrapper">
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-lg-10">
                    <h2>Les clients de l'hôtel ont quitté l'hôtel avec une  D êtte</h2>
                    <ol class="breadcrumb">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Tous les clients avec dette de facture<small>trier, rechercher</small></h5>
...
<?php
            ...
            ?>
              ...
              <?php
                    ...
                    <td><?php echo $firstname.' '.$lastname; ?></td>
                       ...
                       <td>
                           <a href="reservation?id=<?php echo $reservation_id;?>" class="btn btn-xs btn-info">Détails du client</a>
                           <a href="addbillpayment?id=<?php echo $checkoutdetails_id;?>" class="btn btn-xs btn-primary">Ajouter paiement</a>                     
                       </td>      
                    </tr>
                 <?php }?>
                    </tbody>
 ...
 <?php } else {?>
                        <div class="alert  alert-danger">Oops!! Pas encore d'invités avec des factures non réglées</div>
 <?php }?>
                    </div>
                </div>
            </div>
