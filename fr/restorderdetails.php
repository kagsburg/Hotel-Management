...
<!--                         <div class="feed-element">
                    ...
                    <a href="addrestorder?waiter=<?php echo $waiter; ?>&&guest=<?php echo $guest;?>&&ordertype=<?php echo $ordertype; ?>&&table=<?php echo $rtable; ?>" class="btn btn-success"><i class="fa fa-save"></i> Save Order</a>
                                 </div>
