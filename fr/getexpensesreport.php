    ...
    <div id="wrapper">
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Obtenir un rapport de dépenses</h2>
                    <ol class="breadcrumb">
                        <li>              <a href="index"><i class="fa fa-home"></i> Accueil</a>                    </li>
                                          <li class="active">
                            <strong>Generer Rapport</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-8">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Générer un rapport de dépenses <small>Ajouter Nouvel abonnement,
                    Tout champs marqué par un (*) ne devrait pas être laissé vide</small></h5>                           
                        </div>
                        <div class="ibox-content">                           
     <form method="GET" name='form' class="form-horizontal" action="costreport">
...
à</span>
                                    ...
                                    name=end placeholder="date du fin" required="required"/>
                                </div>
                                </div>
                            </div>                                                                      
