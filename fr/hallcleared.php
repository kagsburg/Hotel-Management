    <div id="wrapper">        
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Tous Les Clients Verifiés et Totalement Payés</h2>
                    <ol class="breadcrumb">
                         <li>              <a href=""><i class="fa fa-home"></i> Accueil</a>   </li>
                       
                      
                        <li class="active">
                            <strong>Tous Les Clients Verifiés et Totalement Payés</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>Tous Les Clients Verifiés et Totalement Payés<small>trier, chercher</small></h5>
                                          </div>
