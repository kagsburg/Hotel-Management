    ...
    <div id="wrapper">
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Générer le rapport des réservations </h2>
                    <ol class="breadcrumb">
                ...
                <div class="col-lg-8">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Générer le Rapport des Réservations<small>
                                tous les champs marqués(*) ne doivent pas restés vides</small></h5>                           
                        </div>
                        <div class="ibox-content">                           
                             <form method="GET" name='form' class="form-horizontal" action="reservationsreport">
                                    <div class="form-group" id="data_5">
                               <label class="col-sm-2 control-label">*électionnez l’intervalle de la date</label>
