...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
     <title>Modifier l'abonnement à la salle de sport - Hotel Manager</title>
    ...
    <div id="wrapper">
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    <h2>Modifier l'abonnement à la salle de sport</h2>
                    <ol class="breadcrumb">
                        <li>              <a href=""><i class="fa fa-home"></i> Accueil</a>                    </li>
                        <li>   <a href="gymsubscriptions">Abonnements</a>                       </li>
                        <li class="active">
                            <strong>Modifier l'abonnement</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-10">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Modifier l'abonnement<small>
...
?>
     ...
     <form method="post" name='form' class="form-horizontal" action=""  enctype="multipart/form-data">
                                <div class="form-group"><label class="col-sm-2 control-label">* Nom Complet</label>
                                    ...
                                    class="form-control" placeholder="Nom Complet" required="required" value="<?php echo $fullname; ?>">
                                                                            </div>
                                </div>  <div class="hr-line-dashed"></div>
                                           <div class="form-group"><label class="col-sm-2 control-label">
                                            * Numéro de contact</label>
                                               <div class="col-sm-10"><input type="text" name="number"
                                                class="form-control" placeholder="Numéro de contact" required="required" value="<?php echo $phone; ?>">
                                                </div>
                                </div>
                                ...
                                <div class="col-sm-10" style="">
                                     <select class="form-control" name='bouquet'>
                                         ...
                                         $gymbouquet_id.'_'.$days.'_'.$charge; ?>" selected="">
                                         <?php echo $gymbouquet; ?></option>
                                 <?php
...
while ($row = mysqli_fetch_array($gymbouquets)) {
    ...
    $days=$row['days'];
    ?>
                                    <option value="<?php echo $gymbouquet_id.'_'.$days.'_'.$charge; ?>">
                                    <?php echo $gymbouquet; ?></option>
                                <?php } ?>
                                      </select>   
                                  ...
                                  <div class="hr-line-dashed"></div>
             <div class="form-group"><label class="col-sm-2 control-label">Date debut</label>

                                    <div class="col-sm-10">
                                        <input type="date" name='startdate' class="form-control" 
                                        placeholder="Date debut" value="<?php echo date('Y-m-d', $startdate); ?>">
                                                                            </div>
                                </div>                                                                
                      <div class="form-group">
                                    <div class="col-sm-4 col-sm-offset-2">
                                   
                                        <button class="btn btn-primary" type="submit">Modifier l'abonnement</button>
                                    </div>
                                </div>
                            </form>
                        </div>
