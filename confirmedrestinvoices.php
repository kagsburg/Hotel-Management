...
<head>
   ...
   <title>Confirmed Restaurant Invoices | Hotel Manager</title>
      ...
      <div id="wrapper">
         ...
         <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
               <div class="col-lg-12">
                  <h2>Confirmed Restaurant Invoices between <?php echo date('d/m/Y H:i', $start); ?> and <?php echo date('d/m/Y H:i', $end); ?></h2>
                  <ol class="breadcrumb">
                     <li> <a href=""><i class="fa fa-home"></i> Home</a> </li>
                     <li>
                        <a>Confirmed Restaurant</a>
                     </li>
                     <li class="active">
                        <strong>Confirmed Invoices</strong>
                     </li>
                  </ol>
               </div>
               <div class="col-lg-2">
                  ...
                  <div class="col-lg-12">
                     <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                           <?php
                        //    $restorders = mysqli_query($con, "SELECT * FROM orders WHERE status IN(1,2) AND timestamp>='$start' AND timestamp<='$end'  ORDER BY order_id AND guest='0' DESC");
                           $restorders = mysqli_query($con, "SELECT * FROM orders WHERE status='3' AND timestamp>='$start' AND timestamp<='$end'  ORDER BY order_id AND guest='0' DESC");
                                 ...
                                 <tbody>
                                    ...
                                    ?>
                                       <tr class="gradeA">
                                          ...
                                          <!-- <td> -->
                                             <!-- <a href="restinvoice?id=<?php echo $order_id; ?>" class="btn btn-xs btn-success">View</a>
                                             <?php
                                             ...
                                             <a href="confirmrestuarantorder?id=<?php echo $order_id; ?>" class="btn btn-xs btn-info" 
                                              onclick="return confirm_restuarantorder<?php echo $order_id; ?>()">Confirm</a>
                                             <?php } ?>
                                             <a href="removerestaurantorder?id=<?php echo $order_id;?>" 
                                             class="btn btn-xs btn-danger" onclick="return confirm_delete<?php echo $order_id; ?>()">
                                             <i class="fa fa-delete"></i>Cancel</a>
                                             <script type="text/javascript">
                                             function confirm_delete<?php echo $order_id; ?>() {
                                             return confirm('You are about To Cancel this Request. Are you sure you want to proceed?');
                                             }
                                             function confirm_restuarantorder<?php echo $order_id; ?>() {
