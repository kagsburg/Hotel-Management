...
<head>
    ...
    <title>Get Confirmed Hall Invoices - Hotel Manager</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        <h2>Get Confirmed Hall Invoices </h2>
                        <ol class="breadcrumb">
                        ...
                        <div class="col-lg-6">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Generate Confirmed Hall Invoices <small>All fields marked (*) shouldn't be left blank</small></h5>
                                </div>
                                <div class="ibox-content">
                                    <form method="GET" name='form' class="form" action="confirmedhallinvoices">
                                    <div class="row">
