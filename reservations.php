...
<head>
    ...
    <title>Reservations | Hotel Manager</title>
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    ...
                                    <a href="pendingreservescsv" target="_blank" class="btn btn-sm  btn-success pull-right">Export to Excel</a> <a href="pendingreservesprint" target="_blank" class="btn btn-sm btn-warning pull-right"> Print PDF</a>
                                </div>
                                                ...
                                                ?>
                                                    ...
                                                    <tr class="gradeA">
                                                        ...
                                                        <td>
                                                            ...
                                                            echo $fullname;  ?></td>
                                                        <td>
                                                            <a href="reservation?id=<?php echo $reservation_id; ?>" class="btn btn-xs btn-info">Details</a>
                                                            <a href="cancelbooking?id=<?php echo $reservation_id; ?>" class="btn btn-xs btn-danger" onclick="return confirm_delete<?php echo $reservation_id; ?>()">Cancel</a>
