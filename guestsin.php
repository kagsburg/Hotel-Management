...
<head>
    ...
    <title>Guests In | Hotel Manager</title>
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>All Guests In <small>Sort, search</small></h5>
                                    <a href="guestsinprint" target="_blank" class="btn  btn-warning pull-right"><i class="fa fa-print"></i> Print PDF</a>
                                </div>
                                <div class="ibox-content">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    ...
                                                    <tr class="gradeA">
                                                        ...
                                                        <td>
                                                            <div class="text-success">guest in</div>
                                                        </td>
                                                        <td>
                                    ...
                                    <?php } else { ?>
                                        <div class="alert  alert-danger">Oops!! No Guests In Yet</div>
                                    <?php } ?>
                                </div>
                            </div>
                        </div>
