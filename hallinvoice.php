...
<head>
    ...
    <title>Hall Reservation Invoice | Hotel Manager</title>
    ...
    if ((isset($_SESSION['lan'])) && ($_SESSION['lan'] == 'fr')) {
        ...
        ?>
                                ...
                                <div class="row" style="margin-top: 15px;">
                                    <div class="col-xs-6">
                                        <h4>Invoice No. <span class="text-navy"><?php echo $invoice_no; ?></span></h4>
                                        <address>
                                            <strong>
                                                Guest Name <br>
        ...
        echo number_format($totalcharge); ?></strong></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><strong><?php
           $hallincome = mysqli_query($con, "SELECT 
                                            COALESCE(SUM(amount), 0) AS totalhallincome FROM hallpayments WHERE hallbooking_id='$id'");
