		...
		<div class="signin-container">
			...
			<div class="signin-info">
				...
				<ul>
					...
					<li><i class="fa fa-file-text-o signin-icon"></i> Facile</li>
			...
			<div class="signin-form">
				...
				<form action="" id="signin-form_id" method="post">
					...
					<div class="form-group w-icon">
						<input type="text" name="username" id="username_id" class="form-control input-lg" 
...
">
					...
					<div class="form-group w-icon">
						<input type="password" name="password" id="password_id" class="form-control input-lg" placeholder="Mot de passe">
