...
<head>
    ...
    <title>Guests Out | Hotel Manager</title>
            ...
            <div class="row">
                ...
                <div class="widget style1 red-bg">
                    <div class="row">
                        ...
                        <div class="col-xs-8 text-right">
                            <span>Hotel Guest Out</span>
                            <h2 class="font-bold"><?php
                           $reservations=mysqli_query($con,"SELECT * FROM reservations WHERE  status='2' ORDER BY reservation_id DESC");
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>All Guests Out <small>Sort, search</small></h5>
                       <a href="guestsoutprint" target="_blank" class="btn  btn-warning pull-right"><i class="fa fa-print"></i> Print PDF</a>
                    </div>
