...
<head>
    ...
    <title>Requisitions Orders | Hotel Manager</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        <h2>Requisitions Orders</h2>
                        <ol class="breadcrumb">
                            <li> <a href=""><i class="fa fa-home"></i> Home</a> </li>
                            <li class="active">
                                <strong>Requisitions Orders</strong>
                            </li>
                        </ol>
                    </div>
                    <div class="col-lg-2">
                        ...
                        <div class="col-lg-10">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    ...
                                    $list = mysqli_query($con, "SELECT * FROM requisitions WHERE status IN (1,0,2)  ORDER BY requisition_id DESC");
                                        ...
                                        <table class="table table-striped table-bordered table-hover dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                while ($row =  mysqli_fetch_array($list)) {
                                                    ...
                                                    $status = $row['status'] == '1' ? 'Approved' : ($row['status'] == '2' ? 'Confirmed' : 'Pending');
                                                    ...
                                                    // get department name
                                                    $department = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM departments WHERE department_id = $department_id"));
                                                ...
                                                ?>
                                                    ...
                                                    <tr class="gradeA">
                                                        ...
                                                        <td>
                                                            ...
                                                            if ($status=='Approved') {
                                                                ?>
                                                                <a href="confirmrequisition?id=<?php echo $requisition_id; ?>" class="btn btn-success btn-xs" onclick="return confirmreq<?php echo $requisition_id; ?>()"><i class="fa fa-check"></i>Confirm</a>
                                                            <?php }
                                                            ?>
                                                            <script type="text/javascript">
                                                                ...
                                                                function confirmreq<?php echo $requisition_id; ?>() {
                                                                    return confirm('You are about To Confirm this Requisition List. Do you want to proceed?');
                                                                }
                                                            </script>
                                                        </td>
                                                    </tr>
