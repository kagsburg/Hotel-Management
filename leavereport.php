...
<head>
    ...
    <title>Leaves Report | Hotel Manager</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        <h2>Leaves Report between <?php echo date('d/m/Y', $start); ?> and <?php echo date('d/m/Y', $end); ?></h2>
                        <ol class="breadcrumb">
                ...
                <div class="wrapper wrapper-content animated fadeInRight">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="d-flex">
                                <a href="leavereportprint?st=<?php echo $start; ?>&&en=<?php echo $end; ?>" target="_blank" class="btn btn-success ">Print PDF</a>
                                <a href="leavereportexcel?st=<?php echo $start; ?>&&en=<?php echo $end; ?>" target="_blank" class="btn btn-success ">Export to Excel</a>
                            </div>
                            <br>
                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    <?php
                                    $leaves = mysqli_query($con, "SELECT * FROM leaves  WHERE status='1'  AND  timestamp>='$start' AND timestamp<='$end' ");
                                    ?>
