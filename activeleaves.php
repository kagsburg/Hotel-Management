...
<head>
    ...
    <title>Active Leaves | Hotel Manager</title>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>View Active Leaves</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <h5>All Active Leaves <small>Sort, search</small></h5>
                                          </div>
   ...
   $employee=  mysqli_query($con,"SELECT * FROM employees WHERE employee_id='$employee_id'");
    ...
    ?>
            <tr class="gradeA">
                   ...
                   <td>
                    <a data-toggle="modal"  href="#modal-form<?php echo $leave_id; ?>"  class="btn btn-xs btn-primary">Confirm Return</a>
...
<div id="modal-form<?php echo $leave_id; ?>" class="modal fade" aria-hidden="true">
                                ...
                                <label class="font-noraml">Return Date</label>
