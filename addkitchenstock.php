...
if (($_SESSION['hotelsyslevel'] != 1) && ($_SESSION['sysrole'] != 'Small Stock Attendant')) {
...
<head>
   ...
   <title>Add Kitchen Stock - Hotel Manager</title>
      ...
      <div id="wrapper">
         ...
         <div id="page-wrapper" class="gray-bg">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
               <div class="col-lg-10">
                  <h2>Add Kitchen Stock</h2>
                  <ol class="breadcrumb">
                     <li> <a href=""><i class="fa fa-home"></i> Home</a> </li>
                     <li> <a href="kitchenstock">Kitchen Stock</a> </li>
                     <li class="active">
                        <strong>Add Kitchen Stock</strong>
                     </li>
                  </ol>
               </div>
               <div class="col-lg-2">
                  ...
                  <div class="col-lg-10">
                     <div class="ibox float-e-margins">
                        <div class="ibox-title">
                           <h5>Add New Kitchen Stock <small>All fields marked (*) shouldn't be left blank</small></h5>
                        ...
                        <div class="ibox-content">
                           ...
                           if (isset($_POST['submit'])) {
                              ...
                              if (!empty($errors)) {
                                 ...
                                 mysqli_query($con, "INSERT INTO kitchenaddedstock(date,admin_id,status) VALUES('$date','" . $_SESSION['hotelsys'] . "',1)") or die(mysqli_errno($con));
                                 $last_id = mysqli_insert_id($con);
                                 $allproducts = sizeof($item);
                                 for ($i = 0; $i < $allproducts; $i++) {
                                    $activity = $fullname . ' added ' . $quantity[$i];
                                    mysqli_query($con, "INSERT INTO kitchenstockitems(item_id,quantity,addedstock_id,status) VALUES('$item[$i]','$quantity[$i]','$last_id',1)");
