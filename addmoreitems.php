...
<head>
    ...
    <title>Add More Restaurant Order Items- Hotel Manager</title>
                            ...
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    ...
                                    ?>
                                            ...
                                            <div class="col-sm-10">
                                                <div class="alert alert-success"><i class="fa fa-check"></i>Restaurant Order Successfully Added.Click
                                                    <strong><a href="addrestquantities?id=<?php echo $restround_id; ?>">Here</a> </strong> To Add Number of Items
                                                </div>
                                            </div>
                                    <?php
