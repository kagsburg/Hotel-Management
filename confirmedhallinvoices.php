...
<head>
    ...
    <title>Confirmed Hall Invoices | Hotel Manager</title>
        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper" class="gray-bg">
                ...
                <div class="row wrapper border-bottom white-bg page-heading">
                    <div class="col-lg-10">
                        <h2>Confirmed Hall Invoices between <?php echo date('d/m/Y H:i', $start); ?> and <?php echo date('d/m/Y H:i', $end); ?></h2>
                        <ol class="breadcrumb">
                            <li> <a href=""><i class="fa fa-home"></i> Home</a> </li>
                            <li class="active">
                                <strong>Confirmed Hall Invoices </strong>
                            </li>
                        </ol>
                    </div>
                    <div class="col-lg-2">
                        ...
                        <div class="col-lg-12">
                            <div class="ibox float-e-margins">
                                <div class="ibox-title">
                                    <h5>Confirmed Hall Invoices <small>Sort, search</small></h5>
                                </div>
                                <div class="ibox-content">
                                    <?php
                                    // $reservations = mysqli_query($con, "SELECT * FROM hallreservations WHERE status IN (1,2,3) AND timestamp>='$start' AND timestamp<='$end' ORDER BY hallreservation_id DESC");
                                    $reservations = mysqli_query($con, "SELECT * FROM hallreservations WHERE status='4' AND timestamp>='$start' AND timestamp<='$end' ORDER BY hallreservation_id DESC");
                                    ?>
                                            ...
                                            ?>
                                                    ...
                                                    <tr class="gradeA">
                                                        ...
                                                        <!-- <td>
                                                         ...
                                                         <a href="hallpayment?id=<?php echo $hallreservation_id; ?>" class="btn btn-xs btn-primary">Add Payment</a>
