...
<head>
    ...
    <title>Cancelled  Bar  Orders| Hotel Manager</title>
    ...
    <div id="wrapper">
        ...
        <div class="navbar-header">
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-12">
                    <h2>Hotel  Bar Orders Cancelled</h2>
                    <ol class="breadcrumb">
...
<?php
   $barorders=  mysqli_query($con,"SELECT * FROM barorders WHERE status='0'  ORDER by barorder_id");
 ...
 <?php }else{?>
                        <div class="alert alert-danger">No Drink Orders Cancelled  Yet</div>
 <?php }?>
                    </div>
                </div>
            </div>
