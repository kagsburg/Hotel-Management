...
<head>
    ...
    <title>Pending Lists | Hotel Manager</title>
                        ...
                        <div class="col-lg-10">
                            <div class="ibox float-e-margins">
                                ...
                                <div class="ibox-content">
                                    <?php
                                    $statusForUser = $_SESSION['sysrole'] == "director" ? 3 : 0;
                                    $list = mysqli_query($con, "SELECT * FROM purchaselists WHERE status='$statusForUser' ORDER BY purchaselist_id DESC");
                                                ...
                                                ?>
                                                    ...
                                                    <tr class="gradeA">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="removepurchaselist?id=<?php echo $purchaselist_id; ?>" class="btn btn-danger btn-xs" onclick="return cdelete<?php echo $purchaselist_id; ?>()"><i class="fa fa-trash"></i>Remove</a>
                                                            <script type="text/javascript">                                                            
                                                            function cdelete<?php echo $purchaselist_id; ?>() {
