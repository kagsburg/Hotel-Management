    ...
    if (isset($_SESSION["iproducts"]) && count($_SESSION["iproducts"]) > 0) {
        mysqli_query($con, "INSERT INTO purchaselists(creator,timestamp,status) VALUES('" . $_SESSION['emp_id'] . "',UNIX_TIMESTAMP(),'0')");
    ...
    ?>
        ...
        <div class="col-sm-10">
            <div class="alert alert-success">
                ...
                List Successfully Added. Click <strong><a href="createlist">Here</a></strong> To go back
            </div>
        </div>
    <?php
    }
