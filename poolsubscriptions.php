                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr class="gradeA">
                                                        ...
                                                        <td>
                                                            <a href="poolsubscriptionprint?id=<?php echo $poolsubscription_id; ?>" class="btn btn-xs btn-primary">View Card</a>
                                                            <a href="editpoolsubscription?id=<?php echo $poolsubscription_id; ?>" class="btn btn-xs btn-info">Edit</a>
                                                            <a href="removepoolsubscription?id=<?php echo $poolsubscription_id; ?>" class="btn btn-xs btn-danger" onclick="return cdelete<?php echo $poolsubscription_id; ?>()">Remove</a>
