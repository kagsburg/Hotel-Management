...
<head>
    ...
    <title>Create Requisition- Hotel Manager</title>
    ...
    <script>
        $(document).ready(function() {
            $(".showit").load("requisitionprocess.php", {
                "load_cart": "1"
            });
            ...
            $(".showit").on('click', 'a.remove-item', function(e) {
                ...
                $.getJSON("requisitionprocess.php", {
                    "remove_code": pcode
                ...
                <div class="wrapper wrapper-content">
                    <div class="row">
                        <div class="col-lg-6">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <form class="form-item">
                                                            ...
                                                            <input type="hidden" class="form-control" name="price" required="required" placeholder="Price" value="<?php echo $price; ?>">
                            ...
                            <a href="requisitiondetails" class="btn btn-primary">Proceed</a>
                        </div>
